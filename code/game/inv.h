...
// [QL] E132. MODELINDEX_* is an index into bg_itemlist, and these are Quake
// Live's: item_armor_jacket sits at 4, so every item after it is one higher
// than in Quake 3 (red flag 35, not 34). The game code no longer compares
// against these (ai_dmq3.c asks the item list for giTag); they are kept right
// because botfiles use the same names. Quake Live's own additions:
#define MODELINDEX_ARMORJACKET		4
#define MODELINDEX_SPAWNARMOR		53
#define MODELINDEX_HMG		54
#define MODELINDEX_AMMOHMG		55
